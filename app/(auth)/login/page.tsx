              ...
              >
                ...
                <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-center space-y-1">
                  <p className="text-[11px] font-bold text-emerald-400 flex items-center justify-center gap-1">
                    <Sparkles size={12} />
                    <span>Tài khoản quản trị viên sẵn có:</span>
                  </p>
                  <p className="text-xs text-white font-medium">
                    SĐT: <strong className="text-emerald-300 font-mono">0855550813</strong> • MK: <strong className="text-emerald-300 font-mono">123456</strong>
                  </p>
                  <button
                    type="button"
                    onClick={() => {
                      setLoginId("0855550813");
                      setLoginPassword("123456");
                    }}
                    className="text-[10px] text-emerald-400 hover:underline font-bold mt-1"
                  >
