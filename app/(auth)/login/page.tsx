    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 selection:bg-primary/20 selection:text-primary">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-muted-foreground mt-2">Đăng nhập để quản lý hồ câu của bạn</p>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={isLoading}
            className="w-full h-14 bg-white text-black font-semibold rounded-2xl flex items-center justify-center gap-3 hover:bg-white/90 active:scale-[0.98] transition-all disabled:opacity-50 disabled:pointer-events-none"
          >
            {isLoading ? (
