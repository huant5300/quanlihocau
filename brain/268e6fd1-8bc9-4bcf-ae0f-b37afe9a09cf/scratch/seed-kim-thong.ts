...
async function main() {
  console.log("Seeding Database for Hồ 1, 2, 3...");

  // 1. Create or verify 3 ponds (FishingLake)
  const ponds = [
    { name: 'Hồ 1', totalSpots: 10 },
    { name: 'Hồ 2', totalSpots: 10 },
    { name: 'Hồ 3', totalSpots: 10 },
  ];
  ...
  // 2. Create or verify 2 price rates (FishingPackage) if missing
  const packages = [
