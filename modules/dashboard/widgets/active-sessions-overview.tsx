      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          sessions.slice(0, 4).map((session) => (
            <div key={session.id} className="flex items-center justify-between p-4 bg-accent/30 rounded-2xl group cursor-pointer hover:bg-accent/50 transition-all border border-transparent hover:border-primary/10">
