  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3">
        {packages.length === 0 ? (
          <div className="p-6 border-2 border-dashed border-border/50 rounded-2xl text-center space-y-3">
            <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-wide">
              Chưa có gói câu nào được tạo
            </p>
            <p className="text-[10px] text-muted-foreground">
              Vào <span className="font-black text-primary">Cài đặt → Gói câu</span> để tạo các gói ca câu cố định
            </p>
            <a
              href="/dashboard/settings"
              className="inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-primary hover:opacity-80 transition-opacity"
            >
              Đến Cài đặt →
            </a>
          </div>
